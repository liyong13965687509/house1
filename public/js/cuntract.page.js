...
CustomerPage.prototype.getTemplate = function (params) {
    ...
    for (var i = 0; i < params.length; i++) {
        ...
        TEMP_HTML += '<div class="table-item col-xs-12 col-sm-6 col-md-12"><div class="row-content row">'
            ...
            + '<div class="col-xs-12 col-md-5"><div class="row"><div class="column col-xs-12 col-md-2"><span>合同编号</span></div><div class="column col-xs-12 col-md-2"><span>状态</span></div>'
            + '<div class="column col-xs-12 col-md-2"><span>姓名</span></div><div class="column col-xs-12 col-md-4"><span>手机号码</span></div>'
            + '<div class="column col-xs-12 col-md-2"><span>房号</span></div></div></div><div class="col-xs-12 col-md-2"><div class="row"><div class="column col-xs-12 col-md-7"><span>租金(元/月)</span></div>'
            + '<div class="column col-xs-12 col-md-5"><span>签约</span></div></div></div><div class="col-xs-12 col-md-5"><div class="row"><div class="column col-xs-12 col-md-3"><span>退租</span></div>'
            + '<div class="column col-xs-12 col-md-3"><span>创建</span></div><div class="column col-xs-12 col-md-2"><span>计划</span></div><div class="column col-xs-12 col-md-2"><span>归属人</span></div>'
